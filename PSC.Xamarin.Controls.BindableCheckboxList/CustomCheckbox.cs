...
namespace PSC.Xam.Controls.BindableCheckboxList
{
    public class CustomCheckbox : View
    {
        ...
        public static readonly BindableProperty TextColorProperty =
            BindableProperty.Create<CustomCheckbox, Color>(
        ...
        /// </summary>
        public event EventHandler<GenericEventArgs<bool>> CheckedChanged;
        ...
        public bool Checked
        {
            ...
            set {
                if (this.Checked != value)
                {
                    ...
                    this.CheckedChanged.Invoke(this, new GenericEventArgs<bool>(value));
                }
            }
        }
