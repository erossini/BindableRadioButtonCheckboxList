...
using PSC.Xam.Controls.BindableCheckboxList.Android;
using System;
...
namespace PSC.Xam.Controls.BindableCheckboxList.Android
{
    /// <summary>
    ...
    public class CustomCheckboxRenderer : ViewRenderer<CustomCheckbox, CheckBox>
    {
        ...
        void CheckBoxCheckedChange(object sender, CheckedChangeEventArgs e)
        {
